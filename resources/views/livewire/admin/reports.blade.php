    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
        <div class="flex flex-wrap gap-4">
            <div class="flex-1 min-w-[200px]">
                ...
                <select wire:model="month" class="w-full border border-gray-300 rounded-lg px-4 py-2">
                    @for($m = 1; $m <= 12; $m++)
                        <option value="{{ $m }}">
            ...
            <div class="flex-1 min-w-[200px]">
                ...
                <select wire:model="year" class="w-full border border-gray-300 rounded-lg px-4 py-2">
            ...
            <div class="flex items-end">
                <button wire:click="$refresh" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold">
        ...
        <div class="mt-4 flex space-x-2">
            <a href="{{ route('admin.export.excel', ['month' => $month, 'year' => $year, 'class' => $class]) }}" 
               class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold text-sm">
                <i class="fas fa-file-excel mr-2"></i>Export Excel
            </a>

            <a href="{{ route('admin.export.pdf', ['month' => $month, 'year' => $year, 'class' => $class]) }}" 
