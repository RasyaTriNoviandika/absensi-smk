...
<div class="p-4 sm:p-6 lg:p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-5 border-l-4 border-yellow-500 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-5 border-l-4 border-red-500 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-5 border-l-4 border-purple-500 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="max-h-80 overflow-y-auto">
                @forelse($recentAttendances as $attendance)
                    <div class="px-6 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        <div class="flex items-center justify-between">
                            <div class="flex-1">
                            ...
                            <div class="text-right">
                                ...
                                @if($attendance->status == 'hadir')
                                    <span class="inline-block px-2 py-1 text-xs rounded-full bg-green-100 text-green-800 font-medium">Hadir</span>
                                @elseif($attendance->status == 'terlambat')
                                    <span class="inline-block px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800 font-medium">Terlambat</span>
                                @endif
                            </div>
                        </div>
                    </div>
