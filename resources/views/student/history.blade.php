...
<div class="min-h-screen bg-gray-50 py-4 sm:py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-3 sm:p-4 mb-4 sm:mb-6">
            <form method="GET" class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                    ...
                    <select name="month" class="w-full border border-gray-300 rounded px-3 py-2 text-sm">
                        @for($m = 1; $m <= 12; $m++)
                ...
                <div>
                    ...
                    <select name="year" class="w-full border border-gray-300 rounded px-3 py-2 text-sm">
                ...
                <div class="flex items-end">
                    <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded font-semibold text-sm">
        ...
        <!-- ✅ Table - TANPA NISN, Mobile Friendly -->
